...
console.log(`Notas de 100: ${notas[0]}`);
console.log(`Notas de 50: ${notas[1]}`);
console.log(`Notas de 10: ${notas[2]}`);
console.log(`Notas de 5: ${notas[3]}`);
console.log(`Notas de 1: ${notas[4]}`);