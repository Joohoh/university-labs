...
function calcilarBatimentos(idade) {
...
const batimentos = calcilarBatimentos(idade);

console.log(`O coração de uma pessoa de ${idade} anos baterá aproximadamente ${batimentos} vezes ao longo de sua vida.`);